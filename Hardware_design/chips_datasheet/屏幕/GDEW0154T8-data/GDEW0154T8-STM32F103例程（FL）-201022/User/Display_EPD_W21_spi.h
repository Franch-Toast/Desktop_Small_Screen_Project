...
#define EPD_W21_MOSI_0	GPIO_ResetBits(GPIOA, GPIO_Pin_0)
#define EPD_W21_MOSI_1	GPIO_SetBits(GPIOA, GPIO_Pin_0)

#define EPD_W21_CLK_0	GPIO_ResetBits(GPIOA, GPIO_Pin_1)
#define EPD_W21_CLK_1	GPIO_SetBits(GPIOA, GPIO_Pin_1)

#define EPD_W21_CS_0	GPIO_ResetBits(GPIOA, GPIO_Pin_2)
#define EPD_W21_CS_1	GPIO_SetBits(GPIOA, GPIO_Pin_2)

#define EPD_W21_DC_0	GPIO_ResetBits(GPIOA, GPIO_Pin_3)
#define EPD_W21_DC_1	GPIO_SetBits(GPIOA, GPIO_Pin_3)

#define EPD_W21_RST_0	GPIO_ResetBits(GPIOA, GPIO_Pin_4)
#define EPD_W21_RST_1	GPIO_SetBits(GPIOA, GPIO_Pin_4)
...
#define isEPD_W21_BUSY GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_5) // for solomen solutions
